...
#Answer 1 a)visualize using crimes dataset
...
#using mtcars [dataset], using correlation plot create a correlations matrix
...
#The value of correlation takes place between -1 and +1. Conversely, the value of covariance lies between -infinity and +infinity.
